...
This repository demonstrates reusable AI skills for conducting inception, elicitation, elaboration, negotiation, specification, validation, and requirements management. AI produces drafts; the student owns the reviewed baseline.
...
- [Use Cases](outputs/reviewed/06-use-case.md)
...
- Date: 22 June 2026
- Skills tested: Inception and Specification
